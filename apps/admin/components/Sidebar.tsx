...
// Admin Bug 1 fix: Events uses a "ticket/star" icon; Calendar keeps the grid icon
function CalendarIcon() {
  // Calendar = month grid with dates
...
function MonthIcon() {
  // Events = ticket/star shape — clearly distinct from Calendar
