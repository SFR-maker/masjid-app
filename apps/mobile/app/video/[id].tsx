          ...
          <View style={styles.statsRow}>
            ...
            <Pressable onPress={() => likeMutation.mutate()} style={styles.likeBtn}>
              <Text style={styles.likeBtnText}>
                {video.isLiked ? '❤️' : '🤍'} {video.likeCount ?? 0}
              </Text>
            </Pressable>
          </View>
...
const styles = StyleSheet.create({
  ...
  likeBtn: { flexDirection: 'row', alignItems: 'center', gap: 4, backgroundColor: '#f3f4f6', paddingHorizontal: 14, paddingVertical: 8, borderRadius: 20 },
